    ...
    return (
        <div className="bg-light min-vh-100">
            <div style={Styles.styles.header}>
                ...
                <div className="d-flex flex-column align-items-end">
                    <button 
                        ...
                        onClick={() => { alert('登出成功！'); localStorage.removeItem('user'); navigate('/'); }} 
            ...
            <div style={{ padding: '40px', maxWidth: '500px', margin: '0 auto' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' , backgroundColor: 'white', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)'}}>
                    <div>
                        ...
                        <input 
                            ...
                            required 
                            placeholder="例如: 003"
                            style={{ width: '100%', padding: '8px', backgroundColor: 'white', color: 'black', border: '1px solid #b5b5b5' }}
                        />
                    </div>
                    ...
                    <button 
                        type="submit" 
                        disabled={loading}
                        style={{ padding: '10px', background: '#0f117a', color: 'white', border: 'none', cursor: 'pointer' }}
                    >
                        {loading ? '處理中...' : '確認新增員工'}
                    </button>
                </form>
